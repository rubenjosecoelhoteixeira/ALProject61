pageextension 50008 CustomerCardExt extends "Customer Card"
{
    layout
    {
        addlast(General)
    ...
    begin
        ...
        CurrPage.EnqueueBackgroundTask(TaskSalesId, 50008, TaskParameters, 20000, PageBackgroundTaskErrorLevel::Warning);
    end;
